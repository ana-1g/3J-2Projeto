...
async function visualizarDadosGlobais(){
    ...
    const tempoMedio = dado.tempo_medio
    console.log(dados);
    const paragrafo = document.createElement('p');
    paragrafo.classList.add('graficos-texto');
    paragrafo.innerHTML = 'Voce sabia que o mundo tem ${totalPessoasMundo} de habitantes e destes ${totalPessoasConectadas} estão conectadas a alguma rede social e ficam em média ${tempoMedio} conectadas.'
