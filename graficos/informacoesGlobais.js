...
async function visualizarDadosGlobais(){
    ...
    paragrafo.innerHTML = `Voce sabia que o mundo tem <span> ${totalPessoasMundo} </span> de habitantes e destes <span> ${totalPessoasConectadas} </span> estão conectadas a alguma rede social e ficam em média <span> ${tempoMedio} </span> conectadas.`
